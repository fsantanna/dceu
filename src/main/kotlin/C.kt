fun Coder.main (): String {
    ...
    """ // CREATES
        CEU_Dynamic* ceu_proto_create (CEU_Block* hld, int isperm, int type, CEU_Proto proto) {
            ...
            *ret = (CEU_Dynamic) {
                type, NULL, NULL, NULL, 0, 0, {.Proto=proto}
            };
        ...
        CEU_Dynamic* ceu_tuple_create (CEU_Block* hld, int n, CEU_Value* args) {
            ...
            assert(ret != NULL);
            *ret = (CEU_Dynamic) { CEU_VALUE_TUPLE, NULL, NULL, NULL, 0, 0, {.Tuple={n,{}}} };
            if (args != NULL) {
        ...
        CEU_Dynamic* ceu_vector_create (CEU_Block* hld, CEU_VALUE type, int n, CEU_Value* args) {
            ...
            assert(mem != NULL);
            *ret = (CEU_Dynamic) { CEU_VALUE_VECTOR, NULL, NULL, NULL, 0, 0, {.Vector={n,n,type,mem}} };
            ceu_max_depth(ret, n, args);
            for (int i=0; i<n; i++) {
        ...
        CEU_Dynamic* ceu_dict_create (CEU_Block* hld, int n, CEU_Value (*args)[][2]) {
            ...
            *ret = (CEU_Dynamic) { CEU_VALUE_DICT, NULL, NULL, NULL, 0, 0, {.Dict={min,mem}} };
            if (args != NULL) {
                for (int i=0; i<n; i++) {
        ...
        CEU_RET ceu_coros_create (CEU_Block* hld, int max, CEU_Value* ret) {
            ...
            assert(coros != NULL);
            *coros = (CEU_Dynamic) {
                CEU_VALUE_COROS, NULL, NULL, NULL, 0, 0, {
        ...
        CEU_RET ceu_coro_create (CEU_Block* hld, CEU_Value* task, CEU_Value* ret) {
            ...
            *coro = (CEU_Dynamic) {
                CEU_VALUE_CORO, NULL, NULL, NULL, 0, 0, {
                    .Bcast = { CEU_CORO_STATUS_YIELDED, NULL, {
        ...
        CEU_RET ceu_coro_create_in (CEU_Block* hld, CEU_Dynamic* coros, CEU_Value* task, CEU_Value* ret, int* ok) {
            ...
            *coro = (CEU_Dynamic) {
                CEU_VALUE_CORO, NULL, coros->hold, NULL, 0, 1, { // no free
                    .Bcast = { CEU_CORO_STATUS_YIELDED, NULL, {
        ...
        CEU_Dynamic* ceu_track_create (CEU_Dynamic* coro, CEU_Value* ret) {
            ...
            assert(trk != NULL);
            *trk = (CEU_Dynamic) {
                CEU_VALUE_TRACK, NULL, NULL, NULL, 0, 0, {
                    .Bcast = { CEU_CORO_STATUS_YIELDED, NULL, {
                        .Track = coro
                    } }
                }
            ...
            do {
                {
                    static CEU_Dynamic ceu_type = { 
                        CEU_VALUE_FUNC, NULL, NULL, NULL, 1, 1, {
