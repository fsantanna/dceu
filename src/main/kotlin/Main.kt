...
val GLOBALS = setOf (
    "detrack'", "dump", "error", "hold", "next-dict", "print", "println",   // bc of detrack'' in prelude
...
sealed class Expr (val n: Int, val tk: Tk) {
    ...
    data class Do     (val tk_: Tk, val arg: Pair<Tk.Id,Tk.Tag?>?, val es: List<Expr>) : Expr(N++, tk_)
